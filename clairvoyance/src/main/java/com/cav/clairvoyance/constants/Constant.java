package com.cav.clairvoyance.constants;
...
public class Constant {
     ...
     * 用户权鉴缓存 key
     */
    public static final String IDENTIFY_CACHE_KEY = "shiro-cache:com.cav.clairvoyance.shiro.CustomRealm.authorizationCache:";
}
